...
COPY migrations/0022_stripe_customers.sql                     /migrations/0022_stripe_customers.sql
COPY migrations/0023_stripe_webhook_events.sql                 /migrations/0023_stripe_webhook_events.sql
...
COPY migrations/0027_audit_events.sql                        /migrations/0027_audit_events.sql
COPY migrations/0028_import_job_soft_delete.sql               /migrations/0028_import_job_soft_delete.sql
COPY migrations/0029_audit_events_action_check_widen.sql       /migrations/0029_audit_events_action_check_widen.sql
...
PGPASSWORD=\"$POSTGRES_PASSWORD\" psql -h postgres -U \"$POSTGRES_USER\" -d \"$POSTGRES_DB\" -v ON_ERROR_STOP=1 -f /migrations/0009_risk_profiles.sql && \
     ...
     PGPASSWORD=\"$POSTGRES_PASSWORD\" psql -h postgres -U \"$POSTGRES_USER\" -d \"$POSTGRES_DB\" -v ON_ERROR_STOP=1 -f /migrations/0018_attachment_quota.sql && \
      PGPASSWORD=\"$POSTGRES_PASSWORD\" psql -h postgres -U \"$POSTGRES_USER\" -d \"$POSTGRES_DB\" -v ON_ERROR_STOP=1 -f /migrations/0019_import_jobs.sql && \
       ...
       PGPASSWORD=\"$POSTGRES_PASSWORD\" psql -h postgres -U \"$POSTGRES_USER\" -d \"$POSTGRES_DB\" -v ON_ERROR_STOP=1 -f /migrations/0022_stripe_customers.sql && \
       PGPASSWORD=\"$POSTGRES_PASSWORD\" psql -h postgres -U \"$POSTGRES_USER\" -d \"$POSTGRES_DB\" -v ON_ERROR_STOP=1 -f /migrations/0023_stripe_webhook_events.sql && \
       ...
       PGPASSWORD=\"$POSTGRES_PASSWORD\" psql -h postgres -U \"$POSTGRES_USER\" -d \"$POSTGRES_DB\" -v ON_ERROR_STOP=1 -f /migrations/0027_audit_events.sql && \
PGPASSWORD=\"$POSTGRES_PASSWORD\" psql -h postgres -U \"$POSTGRES_USER\" -d \"$POSTGRES_DB\" -v ON_ERROR_STOP=1 -f /migrations/0028_import_job_soft_delete.sql && \
       PGPASSWORD=\"$POSTGRES_PASSWORD\" psql -h postgres -U \"$POSTGRES_USER\" -d \"$POSTGRES_DB\" -v ON_ERROR_STOP=1 -f /migrations/0029_audit_events_action_check_widen.sql && \
